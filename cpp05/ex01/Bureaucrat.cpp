...
/*   Updated: 2022/01/20 01:09:40 by sbensarg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form& f)
{
	if (f.getIsSigned() == true)
		std::cout << this->getName() << " signs form " << f.getNameForm() << std::endl;
	else
	{
		std::cout << this->getName() << " cannot sign " << f.getNameForm() << " because " << this->getGrade() << " is to low !!" << std::endl;
	}
