...
/*   Updated: 2022/02/07 16:35:47 by sbensarg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const n_form, int const g_s, int const g_e) : _nameform(n_form), _is_signed(false), _grade_s(g_s), _grade_e(g_e)
{
